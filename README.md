...
Current native mobile coverage includes email/password auth, dashboard/calendar data, event creation, code lookup, Host event management, draft-save Host availability editing, Host approve/unconfirm actions, drag-based Guest event reservation creation, reservation-code management, and month/date navigation controls.
